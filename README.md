...
# Домашнее задание к занятию «Подъём инфраструктуры в Yandex Cloud»  - `Старцев Данила Антонович`
...
![Скриншот-4](https://github.com/MindMaze74/upcloud_dz/blob/main/img/4.png)
---
